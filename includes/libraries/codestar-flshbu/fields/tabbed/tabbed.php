 ...
 *
 */
if ( ! class_exists( 'FLSHBU_CSF_Field_tabbed' ) ) {
  class FLSHBU_CSF_Field_tabbed extends FLSHBU_CSF_Fields {
    ...
    public function render() {
      ...
      foreach ( $this->field['tabs'] as $key => $tab ) {
        ...
        foreach ( $tab['fields'] as $field ) {
          ...
          FLSHBU_CSF::field( $field, $field_value, $unique_id, 'field/tabbed' );
