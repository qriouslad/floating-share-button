 ...
 *
 */
if ( ! class_exists( 'FLSHBU_CSF_Field_icon' ) ) {
  class FLSHBU_CSF_Field_icon extends FLSHBU_CSF_Fields {
    ...
    public function enqueue() {
      add_action( 'admin_footer', array( 'FLSHBU_CSF_Field_icon', 'add_footer_modal_icon' ) );
      add_action( 'customize_controls_print_footer_scripts', array( 'FLSHBU_CSF_Field_icon', 'add_footer_modal_icon' ) );
    }
