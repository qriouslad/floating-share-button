 ...
 *
 */
if ( ! class_exists( 'FLSHBU_CSF_Field_textarea' ) ) {
  class FLSHBU_CSF_Field_textarea extends FLSHBU_CSF_Fields {
    ...
    public function shortcoder() {
      ...
      if ( ! empty( $this->field['shortcoder'] ) ) {
        ...
        foreach ( $instances as $instance_key ) {
          ...
          if ( isset( FLSHBU_CSF::$shortcode_instances[$instance_key] ) ) {

            $button_title = FLSHBU_CSF::$shortcode_instances[$instance_key]['button_title'];
