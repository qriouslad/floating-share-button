 ...
 *
 */
if ( ! class_exists( 'FLSHBU_CSF_Field_sortable' ) ) {
  class FLSHBU_CSF_Field_sortable extends FLSHBU_CSF_Fields {
    ...
    public function render() {
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="csf-sortable-item">';
          ...
          FLSHBU_CSF::field( $field, $field_value, $unique_id, 'field/sortable' );
