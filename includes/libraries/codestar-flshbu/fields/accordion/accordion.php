 ...
 *
 */
if ( ! class_exists( 'FLSHBU_CSF_Field_accordion' ) ) {
  class FLSHBU_CSF_Field_accordion extends FLSHBU_CSF_Fields {
      ...
      foreach ( $this->field['accordions'] as $key => $accordion ) {
        ...
        echo '<div class="csf-accordion-item">';
          ...
          foreach ( $accordion['fields'] as $field ) {
            ...
            FLSHBU_CSF::field( $field, $field_value, $unique_id, 'field/accordion' );
